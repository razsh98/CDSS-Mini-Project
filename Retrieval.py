...
def run_window():
    ...
    btn_submit = create_button(col=4, row=6, text="submit", command=retrieve, window=retrieval_window)
    DB = pd.read_excel(raz_path)
    lbl_value = create_label(col=4, row=8, text="", window=retrieval_window)
