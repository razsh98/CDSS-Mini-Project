...
def run_window():
    global ent_name,ent_start_date,ent_start_hour,ent_start_minute,lbl_vaule,DB
    ...
    ent_loinc_num = create_entery(col=3, row=0, text="loinc-num", window=retrieval_H_window)
    lbl_name = create_label(col=2, row=1, text="name patient", window=retrieval_H_window)
    ent_name = create_entery(col=3, row=1, text="name", window=retrieval_H_window)
    ...
    lbl_vaule = create_label(col=4, row=5,text="", window=retrieval_H_window)
